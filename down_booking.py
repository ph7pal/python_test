...
def imgurlList():
    ...
    for i in range(1,total/50+2):
        offset=(i-1)*50
        one_line="http://www.booking.com/searchresults.zh-cn.html?sid=6f235e47f95b9ff60478c66605814bb1;dcid=1;city=-3414440;class_interval=1;csflt=%7B%7D;dtdisc=0;hlrd=0;hyb_red=0;inac=0;nha_red=0;redirected_from_city=0;redirected_from_landmark=0;redirected_from_region=0;review_score_group=empty;score_min=0;ss_all=0;ssb=empty;sshis=0&;rows=50;offset={0}".format(offset)
